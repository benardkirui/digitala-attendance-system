...
$dao= new DAO();
$result= $dao->select_supervisor_attachees($_SESSION['idnumber']);
    ...
    <div class="md-content">
        ...
        <div class="n-modal-body">
            ...
            <div class="row">
                ...
                <a  href="" id="assign_task"  class="btn btn-info col-md-5 md-close" style="margin: 10px">Assign Task</a>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        $("tr").click(
            function()
            {
                ...
                var elem4 = "<li>Institution: "+children[4].innerHTML+"</li>";
                var elem5 = "<li>Course: "+children[5].innerHTML+"</li>";
                var elem6 = "<li>Sub-County: "+children[6].innerHTML+"</li>";
                var elem7 = "<li>Specialization: "+children[7].innerHTML+"</li>";
                $("#list").append(elem1+elem2+elem3+elem4+elem5+elem6+elem7);
                $('#assign_task').attr("href","assign_task.php?assignTask='' & idnumber="+children[2].innerHTML);
